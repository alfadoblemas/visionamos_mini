...
class AgenciasControllerTest < ActionController::TestCase
  ...
  test "should create agencia" do
    assert_difference('Agencia.count') do
      post :create, agencia: { direccion: @agencia.direccion, estado: @agencia.estado, nit: @agencia.nit, nombre: @agencia.nombre, nombre_director: @agencia.nombre_director, telefono: @agencia.telefono }
    end
  ...
  test "should update agencia" do
    patch :update, id: @agencia, agencia: { direccion: @agencia.direccion, estado: @agencia.estado, nit: @agencia.nit, nombre: @agencia.nombre, nombre_director: @agencia.nombre_director, telefono: @agencia.telefono }
    assert_redirected_to agencia_path(assigns(:agencia))
  end
